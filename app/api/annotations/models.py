...
class epitope(models.Model):
    ...
    linear_peptide_seq = models.CharField(
        max_length=4000, blank=True, null=True, default=""
    )
    linear_peptide_modified_seq = models.CharField(
        max_length=4000, blank=True, null=True, default=""
    )
    linear_peptide_modification = models.CharField(
        max_length=85, blank=True, null=True, default=""
    )
    ...
    disc_modification = models.CharField(
        max_length=85, blank=True, null=True, default=""
    )
    ...
    mc_mol1_modification = models.CharField(
        max_length=85, blank=True, null=True, default=""
    )
    mc_mol2_source_id = models.DecimalField(max_digits=22, decimal_places=0)
    mc_mol2_modification = models.CharField(
        max_length=85, blank=True, null=True, default=""
    )
...
class epitope_object(models.Model):
    ...
    source_antigen_accession = models.CharField(
        max_length=85, blank=True, null=True, default=""
    )
...
class object(models.Model):
    ...
    organism_id = models.DecimalField(
        max_digits=22, decimal_places=0, blank=True, null=True
    )
    organism2_id = models.DecimalField(
        max_digits=22, decimal_places=0, blank=True, null=True
    )
    region = models.CharField(max_length=1000, blank=True, null=True)
    starting_position = models.DecimalField(
        max_digits=22, decimal_places=0, blank=True, null=True
    )
    ending_position = models.DecimalField(
        max_digits=22, decimal_places=0, blank=True, null=True
    )
    ...
    mol1_source_id = models.DecimalField(
        max_digits=22, decimal_places=0, blank=True, null=True
    )
    ...
    mol2_source_id = models.DecimalField(
        max_digits=22, decimal_places=0, blank=True, null=True
    )
...
class AnnType(models.Model):
    category = models.ForeignKey(
        AnnCategory, related_name="types", on_delete=models.CASCADE
    )
    created = models.DateTimeField(auto_now_add=True)
    title = models.CharField(max_length=100, blank=True, default="")
    description = models.TextField()
...
class FeatureTrack(models.Model):
    ...
    uniprot_entry = models.ForeignKey(
        UniprotEntry, related_name="tracks", on_delete=models.CASCADE
    )
    # visualization_type
    track_type = models.ForeignKey(
        TrackType, related_name="tracks", on_delete=models.CASCADE
    )
    name = models.CharField(max_length=255, blank=True, null=True, default="")
...
class TrackData(models.Model):
    f_track = models.ForeignKey(
        FeatureTrack, related_name="features", on_delete=models.CASCADE
    )
    ...
    alternativeSequence = models.CharField(
    ...
    reportedProtChange = models.CharField(
        max_length=255, blank=True, null=True, default=""
    )
    genomicPosition = models.IntegerField()
    originalGenomic = models.CharField(
        max_length=255, blank=True, null=True, default=""
    )
...
class Xref(models.Model):
    feature = models.ForeignKey(
        TrackData, related_name="xrefs", on_delete=models.CASCADE
    )
